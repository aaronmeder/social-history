...
var Isotope = __webpack_require__(/*! isotope-layout */ "./node_modules/isotope-layout/js/isotope.js"); // Always say Hi


console.log("Nice to see you here my friend 👋🏻"); // element argument can be a selector string
...
function filterMedia() {
  ...
  if (window.isotope) {
    var thisFilter = this.dataset.filter;
    console.log("filtering for ".concat(thisFilter, "..."));
    window.isotope.arrange({
      filter: "." + thisFilter
    });
  }
}
